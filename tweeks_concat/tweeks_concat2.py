...
df0 = pd.read_csv(path_list[1000], names=('year', 'month', 'day', 'time', 'prate', 'nv', 'twoweeks_max', 'output'))
df0['id'] = str(os.path.split(path_list[1000])[1]).replace('.csv', '')
...
df01.to_csv('all_twoweeks_2.csv', index=False)
