...
df0 = pd.read_csv(path_list[4000], names=('year', 'month', 'day', 'time', 'prate', 'nv', 'twoweeks_max', 'output'))
df0['id'] = str(os.path.split(path_list[4000])[1]).replace('.csv', '')
...
df01.to_csv('all_twoweeks_5.csv', index=False)
