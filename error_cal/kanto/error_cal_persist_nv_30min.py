...
for i in range(12):
    month = i + 1
    path_month = 'H:/study/error_data/kanto_parameter_persist_nv_30min/' + str(month) + '月/'
    ...
    for j in range(day_max):
        ...
        for tt in range(25):
            try:
                ...
                read_path_com = 'H:/study/preprocessing_data/mesh_com/' + str(month) + '月/' + str(month) + '月' + str(day) + '日/mesh_com' + str(year) + str(month) + str(day) + str(tt2) + '.csv'
                ...
                read_path_old = 'H:/study/preprocessing_data/mesh_com/' + str(month) + '月/' + str(month) + '月' + str(day) + '日/mesh_com' + str(year) + str(month) + str(day) + str(round(tt2 - 0.5, 1)) + '.csv'
